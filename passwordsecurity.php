...
//md5 is a hashing function used to generate hashes for passwords
//echo md5("password");This will also work but can be hacked
//Now we use salt for extra security from crack stations
//$salt="jygewkfikhv;ifti987967sdcvj";
